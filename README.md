...
Takosumi v1 は Takosumi 専用 source metadata file を要求しません。build service / CI は Git
...
Takosumi PlanRun は repository metadata、OpenTofu plan artifact、operator-owned
platform service inventory を記録します。`/gui` ダッシュボード、`/mcp`、health /
