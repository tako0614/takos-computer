...
Takosumi の `plan` type Run は SourceSnapshot / DependencySnapshot、OpenTofu plan artifact、policy decision を記録します。credentials / provider bindings は Connection / ProviderBinding / policy で解決されます。`/gui` ダッシュボード、`/mcp`、health /
